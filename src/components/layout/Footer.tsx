...
export function Footer() {
  return (
    <footer className="bg-caramel dark:bg-dark-surface border-t border-white/8 dark:border-espresso/40 py-12 sm:py-14 lg:py-16">
          ...
          <div className="flex flex-col gap-5">
            ...
            <ul className="flex flex-col gap-2.5">
              {[
                ...
                { name: "Seja uma Produtora",   href: "/seja-produtora" },
