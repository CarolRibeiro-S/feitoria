        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
            <div>
              ...
              <h1 className="font-serif text-4xl lg:text-5xl text-espresso mt-2 font-normal">
                Catálogo de Sabores
              </h1>
            </div>
          ...
          <div className="grid lg:grid-cols-[240px_1fr] gap-12">
            ...
            {/* ── MOBILE CATEGORIES ─────────────────────────────────────────── */}
            <div className="lg:hidden flex gap-3 overflow-x-auto pb-4 scrollbar-hide -mx-5 px-5">
              <button
                onClick={() => setSelectedCategory(null)}
                className={`flex-shrink-0 px-5 py-2.5 font-sans text-[0.7rem] tracking-wider uppercase border transition-colors ${
              ...
              {CATEGORIES.map((cat) => (
                <button
                  key={cat.name}
                  onClick={() => setSelectedCategory(cat.name)}
                  className={`flex-shrink-0 px-5 py-2.5 font-sans text-[0.7rem] tracking-wider uppercase border transition-colors flex items-center gap-2 ${
                  ...
                  {filteredProducts.map((product) => (
                    <div key={product.id} className="group flex flex-col bg-cream">
                      <div className="aspect-square overflow-hidden relative">
                        ...
                        {/* Overlay to show "Ver Detalhes" on hover */}
