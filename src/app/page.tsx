          ...
          <div className="max-w-7xl mx-auto px-5 sm:px-8">
            ...
            <div className="flex flex-wrap justify-center gap-6 sm:gap-8">
              {CATEGORIES.map(({ name, Icon }) => (
                ...
                >
                  <div className="w-[4.2rem] h-[4.2rem] sm:w-20 sm:h-20 bg-cream group-hover:bg-beige/70 transition-colors border border-beige/40 flex items-center justify-center">
                    <Icon size={24} strokeWidth={1.4} className="text-olive/80 group-hover:text-olive transition-colors" />
                  </div>
                  <span className="font-sans text-[0.65rem] sm:text-[0.68rem] font-medium text-espresso/75 tracking-wide text-center w-[4.2rem] sm:w-20 leading-tight">
                    {name}
                  </span>
                </a>
              ))}
